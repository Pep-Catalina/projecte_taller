docker image build -t nginx-digitalitzacio nginx/.

docker image build -t mariadb-digitalitzacio mysql/.

docker network create --driver bridge --gateway 192.168.1.254 --subnet 182.168.1.0/24 --attachable digi-network
